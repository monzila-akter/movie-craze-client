    ...
    <section className="container mx-auto py-12 px-6">
      ...
      <div className="space-y-12">
        ...
        <div className="bg-base-100 p-6 rounded-lg shadow-md">
          <h3 className="text-2xl text-red-500 font-semibold text-center mb-7">Trending Categories</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Action</h4>
            </div>
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Comedy</h4>
            </div>
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Drama</h4>
            </div>
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Horror</h4>
            </div>
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Thriller</h4>
            </div>
            <div className="p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
              <h4 className="text-lg font-semibold text-center">Sci-Fi</h4>
            </div>
          </div>
        </div>
        ...
        <div className="bg-base-100 p-6 rounded-lg shadow-md">
          <h3 className="text-2xl text-red-500 font-semibold text-center mb-7">Trending Topics</h3>
        ...
        <div className="bg-base-100 p-6 rounded-lg shadow-md">
          <h3 className="text-2xl font-semibold text-red-500 text-center mb-7">Popular Film Studios</h3>
        ...
        <div className="bg-base-100 p-6 rounded-lg shadow-md">
          <h3 className="text-2xl font-semibold text-red-500 text-center mb-7">Upcoming Movie Releases</h3>
          <ul className="space-y-4">
            <li>
              <Link to="/" className="text-xl text-blue-600 hover:underline">
                "Mufasa: The Lion King – Coming Soon"
              </Link>
            </li>
            <li>
              <Link to="/" className="text-xl text-blue-600 hover:underline">
                "Zero Se Restart – Releasing Next Month"
              </Link>
            </li>
            <li>
              <Link to="/" className="text-xl text-blue-600 hover:underline">
                "Solo Leveling: ReAwakening – In Theaters Soon"
              </Link>
            </li>
          </ul>
        </div>
